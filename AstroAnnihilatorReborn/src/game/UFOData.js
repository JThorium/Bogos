...
export const ufos = [
  ...
  { id: 'omega', name: 'Omega', geometry: { type: 'SphereGeometry', args: [0.5, 32, 32] }, colors: [0.5, 0, 1, 1, 1, 0], pattern: 0, stats: { moveSpeed: 0.1, health: 6, shotCooldown: 5, superchargePower: 1, drones: 2, damage: 1 }, shoot: 'homing', thrusterColor: 0xffff00, unlocked: false, cost: 999999999999, unlockMethod: 'credits', ability: 'The ultimate form. All abilities, double health & fire rate. Hold to cycle abilities.' }
];
